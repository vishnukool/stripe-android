...
internal object PaymentIntentFixtures {
    ...
    val PI_PROCESSING_VISA_3DS2_JSON = JSONObject(
        """
            {
    ...
    val PI_PROCESSING_VISA_3DS2 = PARSER.parse(PI_PROCESSING_VISA_3DS2_JSON)!!

    val PI_VISA_3DS2_SUCCEEDED_JSON = JSONObject(
        """
        {
    ...
    val PI_VISA_3DS2_SUCCEEDED = PARSER.parse(PI_VISA_3DS2_SUCCEEDED_JSON)!!
