 ...
 */
internal class USBankAccountFormForPaymentSheetFragment : Fragment() {
    ...
    val viewModel by viewModels<USBankAccountFormViewModel> {
        USBankAccountFormViewModel.Factory(
            ...
            { USBankAccountFormViewModel.Args(formArgs, true) },
            this
        )
    }
    ...
    private fun MandateCollectionScreen(
        ...
        Column(Modifier.fillMaxWidth()) {
            ...
            PrimaryButton(
                onClick = {
                    clientSecret?.let {
                        viewModel.attach(it, intentId, linkedAccountId, false)
